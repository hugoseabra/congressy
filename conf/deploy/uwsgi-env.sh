...
export UWSGI_POST_BUFFERING=32768
...
export UWSGI_STATIC_EXPIRES_URI="/static-manage/.*\.[a-f0-9]{12,}\.(css|js|png|jpg|jpeg|gif|ico|woff|ttf|otf|svg|scss|map|txt) 315360000"
