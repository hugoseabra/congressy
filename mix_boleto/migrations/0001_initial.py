# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-10-08 10:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cgsy_subscription_uuid', models.UUIDField(db_index=True, verbose_name='UUID de Inscrição (Congressy)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cgsy_transaction_uuid', models.UUIDField(db_index=True, verbose_name='UUID de Transação (Congressy)')),
                ('mix_created', models.DateTimeField(verbose_name='Data de criação (MixEvents)')),
                ('mix_updated', models.DateTimeField(verbose_name='Data de atualização (MixEvents)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cgsy_lot_id', models.PositiveSmallIntegerField(db_index=True, verbose_name='ID da Categoria (Congressy)')),
                ('mix_created', models.DateTimeField(verbose_name='Data de criação (MixEvents)')),
                ('mix_updated', models.DateTimeField(verbose_name='Data de atualização (MixEvents)')),
            ],
            options={
        ...
        migrations.AlterUniqueTogether(
            name='syncsubscription',
            unique_together=set([('sync_resource', 'mix_subscription_id', 'cgsy_subscription_uuid')]),
        ),
        migrations.AlterUniqueTogether(
            name='synccategory',
            unique_together=set([('sync_resource', 'mix_category_id', 'cgsy_lot_id')]),
        ),
        migrations.AlterUniqueTogether(
            name='syncboleto',
            unique_together=set([('mix_boleto', 'cgsy_transaction_uuid')]),
        ),
        migrations.AlterUniqueTogether(
            name='mixboleto',
            unique_together=set([('sync_resource', 'mix_boleto_id', 'cgsy_subscription_uuid')]),
        ),
    ]
