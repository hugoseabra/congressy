# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-07-23 19:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('waiting_funds', 'Aguardando saldo'), ('available', 'Disponível'), ('transferred', 'Transferido')], default='waiting_funds', max_length=15, verbose_name='status')),
                ('type', models.CharField(choices=[('credit', 'Crédito'), ('refund', 'Estono')], max_length=8, verbose_name='tipo')),
                ...
                ('next_check', models.DateField(null=True, verbose_name='próxima verificação em')),
            ],
            options={
