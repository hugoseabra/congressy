...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('gatheros_subscription', '0010_auto_20180511_0355'),
    ]
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_end_sub', models.DateTimeField(
                    help_text='Data e hora limite para se aceitar inscrições para este opcional.',
                ...
                ('optional_type', models.ForeignKey(
                    ...
                    to='addon.OptionalProductType', verbose_name='tipo')),
            ],
            options={
            ...
            bases=(
            gatheros_event.models.mixins.gatheros_model_mixin.GatherosModelMixin,
            base.models.EntityMixin, models.Model),
        ),
        migrations.CreateModel(
            name='Service',
            fields=[
                ...
                ('restrict_unique', models.BooleanField(default=False,
                                                        help_text='Se marcado, os participantes inscritos nesta atividade não poderão se inscrever em outras atividades que estejam em conflito de horário com esta.',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('optional', models.ForeignKey(
                    ...
                    related_name='subscription_services', to='addon.Service',
                    verbose_name='opcional de serviço')),
                ('subscription',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
