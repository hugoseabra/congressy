# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-04-30 13:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, verbose_name='nome')),
                ('date_end_sub', models.DateTimeField(help_text='Data final em que o opcional aceita inscrições.', verbose_name='data final')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.PositiveIntegerField(blank=True, help_text='Limite máximo permitido.', null=True, verbose_name='quantidade')),
                ('release_days', models.PositiveIntegerField(blank=True, default=7, help_text='Número de dias em que serão liberadas as vagas de opcionais caso a inscrição esteja como pendente.', null=True, verbose_name='dias de liberação de opcionais')),
                ('schedule_start', models.DateTimeField(help_text='Data e hora inicial da programação no dia do evento.', verbose_name='data/hora inicial')),
                ('schedule_end', models.DateTimeField(help_text='Data e hora final da programação no dia do evento.', verbose_name='data/hora final')),
