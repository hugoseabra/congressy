    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liquid_price', models.DecimalField(blank=True, decimal_places=2, default=Decimal('0'), help_text='Qual o valor liquido que você espera receber pela venda deste item opcional?', max_digits=10, verbose_name='preço líquido')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscription', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscription_products', to='gatheros_subscription.Subscription', verbose_name='inscrição')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscription', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscription_services', to='gatheros_subscription.Subscription', verbose_name='inscrição')),
            ],
            options={
