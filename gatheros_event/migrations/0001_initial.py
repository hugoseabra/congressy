...
import gatheros_event.lib.validators.cpf_validator
import gatheros_event.lib.validators.phone_validator
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscription_type',
                 models.CharField(choices=[('disabled', 'Desativado'), ('simple', 'Simples'), ('by_lots', 'Por lotes')],
                                  default='simple', max_length=15, verbose_name='inscrições')),
                ('subscription_online', models.BooleanField(default=True, verbose_name='ativar inscrições on-line')),
                ('subscription_offline',
                 models.BooleanField(default=False, help_text='Ativa a sincronização para secretaria',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=11, null=True,
                                           validators=[gatheros_event.lib.validators.phone_validator.phone_validator],
                ...
                ('cpf', models.CharField(blank=True, max_length=11, null=True, unique=True,
                                         validators=[gatheros_event.lib.validators.cpf_validator.cpf_validator],
                                         verbose_name='CPF')),
                ...
                ('city',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='kanu_locations.City',
                                   verbose_name='cidade')),
                ('occupation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                    to='gatheros_event.Place', verbose_name='local'),
        ),
