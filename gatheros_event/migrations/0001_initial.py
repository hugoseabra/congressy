...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateField(auto_created=True, verbose_name='criado em')),
                ('expired', models.DateField(blank=True, null=True, verbose_name='expira em')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', gatheros_event.models.person.TextFieldWithInputText(blank=True, null=True, unique=True, verbose_name='email')),
        ...
        migrations.AddField(
            ...
            name='organization',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invitations', to='gatheros_event.Organization', verbose_name='organização'),
        ),
        migrations.AddField(
            model_name='invitation',
            name='to',
