    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug',
                 models.SlugField(blank=True, editable=False, max_length=128,
                ...
                ('banner_small', stdimage.models.StdImageField(blank=True,
                ...
                ('banner_slide', stdimage.models.StdImageField(blank=True,
                ...
                ('banner_top', stdimage.models.StdImageField(blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.CharField(choices=[('admin', 'Administrador'),
                                                    ('helper', 'Auxiliar')],
                                           default='helper', max_length=10,
                                           verbose_name='grupo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar_height',
                 models.PositiveIntegerField(blank=True, null=True)),
                ('avatar',
                 models.ImageField(blank=True, height_field='avatar_height',
                                   null=True, upload_to='organization',
                                   verbose_name='foto',
                ...
                ('active',
                 models.BooleanField(default=True, verbose_name='ativo')),
                ('internal',
                 models.BooleanField(default=True, verbose_name='interno')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar',
                 models.ImageField(blank=True, null=True, upload_to='person',
                                   verbose_name='foto')),
                ...
                ('politics_version', models.IntegerField(blank=True, null=True,
                ...
                ('city', models.ForeignKey(blank=True, null=True,
                                           ...
                                           verbose_name='cidade')),
                ('occupation', models.ForeignKey(blank=True, null=True,
            ...
            fields=[
                ...
                ('phone',
                 models.CharField(blank=True, max_length=12, null=True,
                                  verbose_name='telefone')),
                ('long', models.DecimalField(blank=True, decimal_places=3,
                                             max_digits=8, null=True,
                                             verbose_name='longitude')),
                ('lat', models.DecimalField(blank=True, decimal_places=3,
                                            max_digits=8, null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config_type', models.CharField(
                    choices=[('text_only', 'Somente texto'), ('image_main',
                ...
                ('image2', stdimage.models.StdImageField(blank=True,
                                                         help_text='Tamanho: 350px x 350px',
                                                         null=True,
                                                         upload_to=gatheros_event.models.info.get_image_path,
                                                         validators=[
                ...
                ('image3', stdimage.models.StdImageField(blank=True,
                                                         help_text='Tamanho: 350px x 350px',
                                                         null=True,
                                                         upload_to=gatheros_event.models.info.get_image_path,
                                                         validators=[
                ...
                ('image4', stdimage.models.StdImageField(blank=True,
                                                         help_text='Tamanho: 350px x 350px',
                                                         null=True,
                                                         upload_to=gatheros_event.models.info.get_image_path,
                                                         validators=[
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name='members', to='gatheros_event.Organization',
                verbose_name='organização'),
        ),
        migrations.AddField(
            model_name='member',
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name='members', to='gatheros_event.Person',
                verbose_name='pessoa'),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name='invitations', to='gatheros_event.Member',
                verbose_name='autor'),
        ),
        migrations.AddField(
            model_name='invitation',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT,
                to='gatheros_event.Category', verbose_name='categoria'),
        ),
        migrations.AddField(
            model_name='event',
            name='organization',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT,
                related_name='events', to='gatheros_event.Organization',
                verbose_name='organização'),
        ),
        migrations.AddField(
            model_name='event',
