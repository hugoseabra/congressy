...
class Event(models.Model):
    ...
    slug = models.CharField(max_length=128, unique=True, editable=False, verbose_name='permalink')
    ...
    banner_small = models.ImageField(blank=True, null=True, verbose_name='banner pequeno',
                                     help_text="Banner pequeno para apresentação geral (tamanho: 580px x 422px)")

    banner_slide = models.ImageField(blank=True, null=True, verbose_name='banner destaque',
                                     help_text="Banner pequeno para destaque (tamanho: 1140px x 500px)")

    banner_top = models.ImageField(blank=True, null=True, verbose_name='banner topo do site',
