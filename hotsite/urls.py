...
public_hotsite_urls = [
    ...
    url(r'^(?P<slug>[\w-]+)/subscription/status/$', views.HotsiteSubscriptionStatusView.as_view(), name='hotsite-subscription-status'),
    url(r'^(?P<slug>[\w-]+)/coupon/$', views.CouponView.as_view(), name='hotsite-coupon'),
]
