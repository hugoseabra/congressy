# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-07-20 11:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('csv_file', models.FileField(upload_to=csv_importer.models.csv_file_config.get_file_path, validators=[csv_importer.validators.validate_csv_only_file])),
                ('error_csv_file', models.FileField(upload_to=csv_importer.models.csv_file_config.get_err_file_path, validators=[csv_importer.validators.validate_csv_only_file])),
                ('success_csv_file', models.FileField(upload_to=csv_importer.models.csv_file_config.get_success_file_path, validators=[csv_importer.validators.validate_csv_only_file])),
