    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('csv_file', models.FileField(upload_to=csv_importer.models.csv_file_config.get_file_path, validators=[csv_importer.validators.validate_csv_only_file], verbose_name='Arquivo CSV')),
                ('error_csv_file', models.FileField(storage=csv_importer.models.storage.OverwriteStorage(), upload_to=csv_importer.models.csv_file_config.get_err_file_path, validators=[csv_importer.validators.validate_csv_only_file])),
