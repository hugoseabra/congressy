# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-08-28 13:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attended_on', models.DateTimeField(auto_now_add=True, null=True, verbose_name='imprimiu a etiqueta em')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attended_on', models.DateTimeField(auto_now_add=True, null=True, verbose_name='imprimiu a etiqueta em')),
                ('attended_by', models.PositiveIntegerField(verbose_name='criado por')),
                ('attendance_service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='checkouts', to='attendance.AttendanceService', verbose_name='Lista de Check-in/out')),
                ('checkin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='checkouts', to='attendance.Checkin', verbose_name='Check-in')),
                ('subscription', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='checkouts', to='gatheros_subscription.Subscription', verbose_name='Inscrito')),
            ],
            options={
                'abstract': False,
                'verbose_name': 'Attendance',
