...
from survey.forms import ComplexQuestionForm, \
    SimpleQuestionForm, QuestionModelForm
...
class CreateSurveyView(EventViewMixin, generic.TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['simple_form'] = SimpleQuestionForm(prefix='simple_form')
        context['complex_form'] = ComplexQuestionForm(prefix='complex_form')
    ...
    def post(self, request):
        ...
        simple_form = SimpleQuestionForm(prefix='simple_form')
        complex_form = ComplexQuestionForm(prefix='complex_form')
        ...
        if form_type == 'simple':
            simple_form = SimpleQuestionForm(request.POST,
                                             prefix='simple_form')
            ...
            complex_form = ComplexQuestionForm(request.POST,
                                               prefix='complex_form')
