...
function publishLot(lot_id) {
    ...
    save_lot('/api/subscription/lots/' + lot_id + '/?show_private=1&show_inactive=1', data, 'Lote publicado com sucesso!');
...
function unpublishLot(lot_id) {
    ...
    save_lot('/api/subscription/lots/' + lot_id + '/?show_private=1&show_inactive=1', data, 'Lote despublicado com sucesso!');
...
function save_survey() {
    ...
    save_lot(
        '/api/subscription/lots/' + lot_id + '/?show_private=1&show_inactive=1',
